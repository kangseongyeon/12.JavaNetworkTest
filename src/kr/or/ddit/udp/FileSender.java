...
public class FileSender {
   ...
   public FileSender(String receiveIp, int port) {
      try {
         ...
         file = new File("d:/D_Other/wok6.jpg");
   ...
   public void start() {
      ...
      try {
         ...
         sendData(String.valueOf(fileSize).getBytes()); // 총 파일 크기를 전송(bytes)
         ...
         while(true) {
            ...
            sendData(buffer, readBytes); // 읽어온 파일내용 전송하기
   ...
   public static void main(String[] args) {
      new FileSender("192.168.36.105", 8888).start();
   }
}
